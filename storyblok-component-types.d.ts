...
export interface BlocksGroupStoryblok {
  ...
  blocks?: (
    ...
    | blog_slider
    | boxes_slider
    | careers_listing_copy
    | case_studies_listing
    | case_studies_recap
    | case_studies_recap_category
    | case_study_recap_item
    | case_study_recap_item_perk
    | cookie_settings
    | cta_image
    ...
    | embed_image_box
    | enterprise_box_grid
    | enterprise_case_study_references
    | enterprise_cta_group
    | enterprise_cta_section
    | enterprise_facts
    | enterprise_faqs
    | enterprise_intro
    | enterprise_logos
    | enterprise_pricing
    | enterprise_pricing_section
    | enterprise_quote_references
    | enterprise_quote_reference_slider
    | enterprise_single_box
    | enterprise_spacer
    | enterprise_table
    | enterprise_techs
    | enterprise_text
    | enterprise_text_image
    | enterprise_two_text
    | enterprise_video
    | events_listing
    | facts_with_images
    | form_section_enterprise
    | hero
    | link_boards
    | list_with_image
    | main_card
    | main_card_with_stats
    | newsletter_form
    | newsletter_section
    | page_intro
    | paper_cta
    ...
    | teasers
    | tech_logos
    | technology_partners_listing
    | text_form
    | text_illustration_grid
    | text_illustration_grid_item
    | text_images
    | text_map_logos
    | text_quotes_illustration
    | title_with_cta
    | tutorials_listing
    | whitepapers_listing
  )[];
...
export interface BlogEntryStoryblok {
  ...
  body?: (
    ...
    | in_content_gated_content
    | in_content_link_board
    | in_content_link_board_link
    | in_content_link_boards
    | in_content_nested_shared_content
    | in_content_newsletter
    | in_content_slider
    | in_content_spacer
    | in_content_tabs
    | markdown
...
export interface ChangelogStoryblok {
  ...
  body?: (
    ...
    | cta_with_expandable_content
    | cta_with_icons
    | cta_with_icons_list_item
    | custom_boxes_grid
    | custom_boxes_grid_box
    | custom_boxes_grid_small_box
    | customer_logo
    | customers_logos
    | custom_richtext
    | custom_table
    ...
    | navigation_item
    | navigation_menu
    | navigation_sidebar_image_link
    | navigation_sidebar_images_links
    | navigation_sidebar_images_links_item
    | navigation_sidebar_links
    | navigation_sidebar_links_link
    | nested_cta
    | newsletter_form
    | newsletter_section
    | page
    ...
    | text_images
    | text_images_facts
    | text_images_text_circles
    | text_link
    | text_logos_links
    | text_logos_links_group
    | text_logos_links_logo
    | text_map_logos
    | text_quotes_illustration
    | text_quotes_illustration_link
    | title_with_cta
    | top_cta
    | top_cta_item
    | tutorials
